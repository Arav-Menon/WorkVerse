...
export default function AiLabPage() {
  ...
  const [orgs] = useState([
    { name: "ClevenStudios", slug: "clevenstudios", desc: "Product design & dev", members: 12, workspaces: 4, online: 8, avatar: "CS", color: "purple" as const, updated: "5m ago" },
    { name: "NexaLabs", slug: "nexalabs", desc: "AI research & infra", members: 31, workspaces: 7, online: 14, avatar: "NX", color: "teal" as const, updated: "1m ago" },
    { name: "SkyForge", slug: "skyforge", desc: "Cloud infrastructure", members: 9, workspaces: 3, online: 2, avatar: "SK", color: "coral" as const, updated: "18m ago" },
  ]);
