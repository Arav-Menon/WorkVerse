  ...
  return (
    <header className="w-full h-[56px] bg-black/80 backdrop-blur-md border-b border-zinc-900 sticky top-0 z-[100] flex items-center justify-between px-4 sm:px-6" role="banner">
      ...
      <nav className="flex items-center gap-1.5" aria-label="Account controls">
        <button className="relative w-8 h-8 flex items-center justify-center rounded-full text-zinc-400 hover:bg-zinc-900 hover:text-white transition-all cursor-pointer" aria-label="Notifications (3 unread)">
          <i className="ti ti-bell text-sm" aria-hidden="true"></i>
          <span className="absolute top-[8px] right-[8px] w-1.5 h-1.5 rounded-full bg-white"></span>
        </button>
        ...
        <div className="w-6 h-6 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-[9px] font-semibold text-zinc-300 select-none cursor-pointer" role="button" tabIndex={0} aria-label="Arav Kumar — profile menu">
          AK
        </div>
