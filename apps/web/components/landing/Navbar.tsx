...
export default function Navbar() {
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-6">
      <nav className="flex items-center gap-8 px-6 py-2.5 rounded-full border border-white/10 bg-black/40 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative group">
        {/* Soft border glow */}
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-4 border-l border-white/10 pl-4 ml-2">
            <button className="text-[11px] uppercase tracking-widest text-zinc-300 hover:text-white transition-colors cursor-pointer font-bold">Sign In</button>
          </div>
          
          <button className="relative group/cta px-5 py-2 rounded-full bg-white text-black text-[11px] uppercase tracking-widest font-bold hover:bg-zinc-200 transition-all cursor-pointer overflow-hidden shadow-[0_0_20px_rgba(255,255,255,0.1)]">
